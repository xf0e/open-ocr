...
func (ocrRequest *OcrRequest) String() string {
	return fmt.Sprintf("ImgUrl: %s, EngineType: %d, Preprocessors: %s, Request ID: %s", ocrRequest.ImgUrl, ocrRequest.EngineType, ocrRequest.PreprocessorChain, ocrRequest.RequestID)
}
