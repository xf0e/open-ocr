...
func main() {
	...
	http.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
		text := `<!DOCTYPE html><html lang="en"> <head> <meta charset="utf-8"> <title>open-ocr</title></head> <body>` +
...
'+.,...,;:P'  \ BBBBBBBBBBBBBBB
			...
			<p>Need <a href="https://godoc.org/github.com/xf0e/open-ocr">docs</a>?</p></section>` +
