...
.nes-btn {border-image-slice: 2;border-image-width: 2;border-image-outset: 2;position: relative;border-style: solid;
border-width: 4px;text-decoration: none;background-color: #92cc41;display: inline-block;padding: 6px 8px;color: #fff;
